...
<head>
  <meta charset="UTF-8">
  <title>German A1 Course Login</title>
  ...
  <style>
    ...
    #loginSection {
      ...
      align-items: center;
      background: url('https://images.unsplash.com/photo-1529070538774-1843cb3265df?auto=format&fit=crop&w=1350&q=80') no-repeat center center/cover;
    }
    #loginBox {
    ...
    #loginBox h2 { margin-bottom: 1rem; color:#333; }
    #loginBox input {
      width: 100%;
      padding: 10px;
      margin: 0.5rem 0;
    ...
    #loginBox button:hover { background:#115293; }
